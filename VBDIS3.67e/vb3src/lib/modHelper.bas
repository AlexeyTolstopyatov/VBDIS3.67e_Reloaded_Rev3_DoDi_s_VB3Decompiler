'
' Modified: CoffeeLake 04.03.2026
'
...
'Konstantendeklationen f�r Registry.cls

'Registrierungsdatentypen
Public Const REG_SZ As Long = 1                         ' String
Public Const REG_BINARY As Long = 3                     ' Bin�r Zeichenfolge
...
'////////////////////////////////////////////////////////////////////////
'// BlockAlign_l  -  Erzeugt einen linksb�ndigen BlockString
'//
...
Public Function BlockAlign_l(RawString, Blocksize) As String
  'String k�rzen lang wenn zu
   RawString = Left(RawString, Blocksize)
  'mit Leerzeichen auff�llen
